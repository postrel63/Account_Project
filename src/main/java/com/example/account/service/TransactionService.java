...
public class TransactionService {
    ...
    @Transactional
    public void saveFailUseTransaction(String accountNumber, Long amount) {
        Account account = accountRepository.findByAccountNumber(accountNumber)
                .orElseThrow(() -> new AccountException(ErrorCode.ACCOUNT_NOT_FOUND));
    ...
    private void validateCancelBalance(Transaction transaction, Account account, Long amount) {
        ...
        if (transaction.getTransactedAt().isBefore(LocalDateTime.now().minusYears()))
    ...
    @Transactional
    public void saveFailCancelTransaction(String accountNumber, Long amount) {
        Account account = accountRepository.findByAccountNumber(accountNumber)
                .orElseThrow(() -> new AccountException(ErrorCode.ACCOUNT_NOT_FOUND));
